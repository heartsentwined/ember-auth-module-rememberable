...
Em.onLoad('Ember.Application', function (application) {
  return application.initializer({
    ...
    initialize: function (container, app) {
      return app.register('authModule:rememberable', get$(get$(Em, 'Auth'), 'RememberableAuthModule'));
    }
  });
});// Generated by EmberScript 0.0.7
var get$ = Ember.get;
...
set$(get$(Em, 'Auth'), 'RememberableAuthModule', Ember.Object.extend({
  init: function () {
    ...
    this.patch();
    get$(this, 'auth').addHandler('signInSuccess', get$(this, 'remember'));
    get$(this, 'auth').addHandler('signInError', get$(this, 'forget'));
    return get$(this, 'auth').addHandler('signOutSuccess', get$(this, 'forget'));
  },
